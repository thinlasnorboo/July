...
import { ArrowRight, ChevronRight, MapPin, GaugeCircle, Wrench, Coffee } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[90vh] md:h-screen flex items-center justify-center overflow-hidden bg-background">
        ...
        {/* Huge Watermark Logo behind content */}
        ...
        <div className="container relative z-20 flex flex-col items-center text-center space-y-8 px-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-none border border-primary/30 bg-primary/10 text-primary text-xs uppercase tracking-widest font-bold mb-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <p className="max-w-2xl text-lg md:text-xl text-zinc-300 font-medium tracking-wide animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            Professional RC tracks, high-performance rentals, and a fully stocked cafe. The ultimate pit stop for RC enthusiasts.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
            ...
            <Button asChild size="lg" variant="outline" className="rounded-none h-14 px-8 text-base uppercase tracking-widest font-bold border-white/20 text-white hover:bg-white/10 hover:text-white group bg-background/20 backdrop-blur-sm">
              <Link href="/menu">
                View Menu
              </Link>
            </Button>
      ...
      <section className="py-24 bg-card border-y border-border/50 relative overflow-hidden">
        <div className="absolute right-0 top-0 w-1/2 h-full opacity-10 bg-[url('data:image/svg+xml;base64,')] mix-blend-overlay" style={{backgroundSize: '40px 40px'}}></div>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Open 7 days a week. Book your track time online to guarantee your spot on the driver's stand.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              <div className="flex justify-between items-center p-4 border border-border/50 bg-background/50">
                <span className="font-bold">30 Minutes</span>
                <span className="text-primary font-serif text-xl font-bold">₹150</span>
              </div>
              <div className="flex justify-between items-center p-4 border border-border/50 bg-background/50">
                <span className="font-bold">1 Hour</span>
                <span className="text-primary font-serif text-xl font-bold">₹250</span>
              </div>
              <div className="flex justify-between items-center p-4 border border-border/50 bg-background/50">
                <span className="font-bold">Full Day Pass</span>
                <span className="text-primary font-serif text-xl font-bold">₹700</span>
              </div>
              <div className="flex justify-between items-center p-4 border border-border/50 bg-background/50">
                <span className="font-bold">Basic Drift Rental (15m)</span>
                <span className="text-primary font-serif text-xl font-bold">₹150</span>
              </div>
            </div>
      ...
      <section className="py-24 bg-background">
        <div className="container text-center max-w-2xl">
          ...
          <Button asChild variant="outline" className="rounded-none uppercase tracking-widest font-bold border-primary/50 hover:bg-primary hover:text-primary-foreground">
            <a href="https://maps.app.goo.gl/Ax5oZPLmYdmaUmk56" target="_blank" rel="noreferrer">Open in Google Maps</a>
          </Button>
        </div>
      </section>
    </div>
